...
reject doc/erhe/meshoptimizer_attribute_encodings.md. Rendering identity is NOT
...
of doc/erhe/meshoptimizer_integration.md: the base variant is always float3), which
