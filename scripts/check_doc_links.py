...
SCAN_ROOTS = ["src/erhe", "src/editor", "src/example", "src/hello_swap", "src/hextiles", "src/CMakeLists.txt", "scripts", "doc", ".github", "cmake", "AGENTS.md", "CLAUDE.md", "Readme.md", "mcp_server_usage.md", "CMakeLists.txt", "prompt_queue.txt"]
