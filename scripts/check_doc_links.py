...
SCAN_ROOTS = ["src/erhe", "src/editor", "src/example", "src/hello_swap", "src/hextiles", "src/CMakeLists.txt", "scripts", "doc", ".github", "cmake", ".claude/skills", "AGENTS.md", "CLAUDE.md", "CHANGELOG.md", "Readme.md", "CMakeLists.txt", "prompt_queue.txt"]
