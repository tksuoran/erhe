...
`doc/erhe/meshoptimizer_integration.md` first; this builds directly on the encoding
split it describes (requirements 9-11). Position quantization has its own
document, `doc/erhe/vertex_position_quantization.md`.
...
only**. It builds on the harness in `doc/erhe/meshoptimizer_integration.md` ("How
