...
`doc/erhe/draw_list_renderer.md` keeps the per-pass Camera / Light / Joint update
...
- R8a in `doc/erhe/draw_list_renderer.md` and the code comments citing it state the
