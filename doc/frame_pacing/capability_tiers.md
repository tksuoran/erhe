...
1. [frame_pacing_control_model.md](control_model.md) — control-theory model
2. [frame_pacing_algorithm.md](algorithm.md) — algorithm design, verified (C1–C8, `scripts/frame_pacing_sim.py`)
3. [frame_pacing_inputs.md](inputs.md) — input inventory and sourcing
4. [frame_pacing_behavior.md](behavior.md) — behavior specification per scenario
