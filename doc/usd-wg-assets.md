...
| full_assets/UsdCookie | UsdCookie.usdz | ok | 8 | 7 | 1 | 1 | 0 | 4 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/full_assets_UsdCookie_UsdCookie.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
...
| test_assets/RoughnessTest | RoughnessTest.usdz | ok | 49 | 26 | 6 | 6 | 0 | 12 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_RoughnessTest_RoughnessTest.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
...
| test_assets/USDZ/AnimatedCube | AnimatedCube.usdz | ok | 9 | 10 | 1 | 1 | 0 | 1 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_USDZ_AnimatedCube_AnimatedCube.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
...
| test_assets/USDZ/BrainStem | BrainStem.usdz | ok | 187 | 128 | 59 | 59 | 0 | 60 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_USDZ_BrainStem_BrainStem.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
| test_assets/USDZ/CesiumMan | CesiumMan.usdz | ok | 14 | 13 | 1 | 1 | 0 | 1 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_USDZ_CesiumMan_CesiumMan.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
| test_assets/USDZ/DamagedHelmet | DamagedHelmet.usdz | ok | 12 | 11 | 1 | 1 | 0 | 1 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_USDZ_DamagedHelmet_DamagedHelmet.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
| test_assets/USDZ/InterpolationTest | InterpolationTest.usdz | ok | 37 | 29 | 10 | 10 | 0 | 10 warning; Attribute `*` does not exist in Prim <prim> | logs/usd_wg_survey/test_assets_USDZ_InterpolationTest_InterpolationTest.usdz.png | works, gap: Attribute `*` does not exist in Prim <prim> |
...
| 7 | warning | MCP server: dropped expired '*' before processing | not a USD gap: editor-internal noise this survey happens to capture |
