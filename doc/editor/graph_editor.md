...
also underpins the render graph. See `doc/erhe/graph.md`.
...
`.glb`, `doc/editor/scene_serialization.md`): the root-level `ERHE_node_graphs`
...
(persistence, `ERHE_node_graphs` extension - see `doc/editor/scene_serialization.md`),
