...
selection and the active scene of `doc/editor/selection.md`.
...
state, see `doc/editor/selection.md`). It is the item most recently
...
target scoping of `doc/editor/selection.md`. Whether the active
