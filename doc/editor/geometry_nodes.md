...
- **Operations**: subdivide (Catmull-Clark / sqrt3, iteration count), conway
  ...
  (`doc/editor/lattice_deform_geometry_node.md`).
...
- **Combiners and values**: join, math, float / integer / vector constants,
  ...
  (`doc/editor/geometry_graph_transform_from_node.md`).
...
src/editor/geometry_graph/
    ...
    graph_mesh.hpp / .cpp                 -- The Graph_mesh asset (doc/editor/geometry_graph_mesh.md)
    ...
    nodes/
        ...
        join_geometry_node
        lattice_node                      -- doc/editor/lattice_deform_geometry_node.md
        math_node
        ...
        transform_from_node               -- doc/editor/geometry_graph_transform_from_node.md
        transform_node
...
| `src/editor/graph_editor/*` | Shared graph-editor node, asset and window infrastructure (`doc/editor/graph_editor.md`) |
| `src/erhe/geometry/erhe_geometry/operation/*` | The geometry operations the nodes wrap (`doc/erhe/geometry.md`) |
