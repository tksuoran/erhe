...
(`doc/usd_compatibility_design.md` U4): the template owns them, the instance's
...
- **The BLAS cache key can go stale over recycled buffer ranges** when
  ...
  it - doc/raytrace.md, "Open lead: the BLAS cache key can go stale".
- **One empty scene costs ~688 MB of estimated texture memory** - doc/plans/todo.md,
