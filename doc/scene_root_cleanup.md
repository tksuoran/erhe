# Scene_root cleanup -- postmortem

Steps 1 and 2 below shipped in commit 3d570726. The remaining steps
were either deferred or rejected per the original plan. Document is
kept as a historical reference; do not treat the "Recommended
approach" section below as outstanding work.
