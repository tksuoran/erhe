§MBEL:5.0
©erhe::Topic::windows
@scope::Windows-only build/clangd/VS-MCP/minidump facts
@docs::doc/agents/windows.md+doc/agents/debugging.md
...
[VS_MCP]
symbol_workspace::¬cpp-index{C#-oriented,0-matches}→goto_definition/find_references-from-open-documents+Grep{doc/agents/debugging.md=canonical-debug/build-flow}
