...
?X2-commit-4{IN-PROGRESS-via-coder:USD-over-prims-below-carrier+root-layer-spec-read;glTF-ERHE_node.overrides-on-carrier;apply_instance_overrides-shared-by-usd/gltf/reload;refresh_instance_subtrees-capture+reapply}
