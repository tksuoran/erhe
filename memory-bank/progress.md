...
?X4-commit-2{IN-PROGRESS:editor-Variant_table-on-Scene_root+Scene_settings.variant_selections+select_variant+Properties-combo+MCP-get_scene_variants/select_variant+save_scene_usd-fill}
