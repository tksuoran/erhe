...
>F1-scene-close-fixes{856dedd3,2026-07-16-eve}✓{per-part-close_scene-subscriptions}
  ...
  NOT-done::clipboard{OPEN-user-decision:pin+whitelist|pin-no-whitelist|drop-on-close;clone-at-copy-REJECTED;plan-"Open decisions"}
...
[OPEN]
?clipboard-treatment{user-decision;options-in-plan}
