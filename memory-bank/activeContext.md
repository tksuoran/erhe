...
>node-properties-graph-selection::IMPLEMENTED✓{2026-07-15,commits:a2eeba7b+bc8c8377+c62ef868;user-verified-selection+pin-edges}
  ...
  interactive-resize{042d7c13,AWAITING-user-interactive-verify}::drag-node-edges/corners-resizes{sizing-cursors-on-hover;right/bottom/BR=resize-in-place,left/top+other-corners=resize+reposition;interior-drag-still-moves;drives-ui_width/height→persists}
