...
// What a pending-capable acquire found (doc/editor/async_asset_loading_design.md 2.9).
...
public:
    ...
    // (doc/editor/async_asset_loading_design.md 2.1). Called from Editor::tick()
    ...
    // Removal announcement (doc/editor/import_undo_reference_clearing.md). The
