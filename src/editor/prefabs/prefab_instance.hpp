...
// (doc/erhe/usd_compatibility_design.md X1); a glTF prefab instance is a reference.
...
// file, or one prim of a USD file (doc/erhe/usd_compatibility_design.md X1). The
