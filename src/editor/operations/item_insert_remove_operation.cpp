...
// cached references to it (doc/editor/import_undo_reference_clearing.md). Scene nodes
...
void collect_subtree_references(const std::shared_ptr<erhe::Hierarchy>& hierarchy, std::unordered_set<const erhe::Item_base*>& out_items)
{
    ...
    // (doc/erhe/usd_compatibility_design.md U4), so a removed material kept for undo
