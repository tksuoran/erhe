...
// What the active item means to an operation (doc/editor/active_item.md D6).
...
public:
    ...
    // Operations "Attach" (doc/editor/active_item.md D6, Blender Ctrl-P): parent
...
private:
    ...
    // reference, doc/editor/active_item.md D6) and at least one other node in the
