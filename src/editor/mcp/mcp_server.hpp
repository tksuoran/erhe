...
private:
    ...
    // fills result. The parent is any prim (doc/erhe/usd_compatibility_design.md C5);
    ...
    auto action_frame_scene     (const nlohmann::json& args) -> std::string;
    ...
    auto action_import_usd      (const nlohmann::json& args) -> std::string;
