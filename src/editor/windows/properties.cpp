...
void Properties::material_properties()
{
    ...
    m_context.material_preview->update_rendertarget(*m_context.graphics_device, m_context.material_preview->get_reverse_depth());
    ...
    add_entry("Circular Brushed Metal", [&](){ ImGui::Checkbox("##",    &data.use_circular_brushed_metal); });
    add_entry("Aniso Control",          [&](){ ImGui::Checkbox("##",    &data.use_aniso_control); });
