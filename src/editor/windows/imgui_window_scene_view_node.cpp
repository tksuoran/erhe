...
auto Imgui_window_scene_view_node::get_consumer_input_viewport(const erhe::rendergraph::Routing resource_routing, const int key, const int depth) const -> erhe::math::Viewport
{
...
auto Imgui_window_scene_view_node::get_producer_output_viewport(const erhe::rendergraph::Routing resource_routing, const int key, const int depth) const -> erhe::math::Viewport
{
    static_cast<void>(resource_routing); // TODO Validate
    static_cast<void>(depth);
    static_cast<void>(key);
