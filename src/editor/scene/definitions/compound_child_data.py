...
struct("Compound_child_data",
    ...
    fields=[
        ...
        field("radius",       Optional(Float),                       added_in=1, short_desc="For sphere/capsule; bottom radius for tapered capsule"),
        field("axis",         Optional(Int),                         added_in=1, short_desc="0=X, 1=Y, 2=Z"),
        field("length",       Optional(Float),                       added_in=1, short_desc="For capsule/tapered capsule"),
        ...
        field("top_radius",   Optional(Float),                       added_in=2, short_desc="For tapered capsule"),
    ],
)
