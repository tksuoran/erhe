...
void initialize_logging()
{
    ...
    log_raytrace_frame             = erhe::log::make_logger("editor::raytrace_frame"            , spdlog::level::info, false);
    ...
    log_trs_tool_frame             = erhe::log::make_logger("editor::transform_tool_frame"      , spdlog::level::info, false);
