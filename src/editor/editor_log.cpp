...
std::shared_ptr<spdlog::logger> log_frame_pacing;
...
std::shared_ptr<spdlog::logger> log_watchdog;
...
void initialize_logging()
{
    ...
    log_frame_pacing               = make_logger      ("editor.frame_pacing"              );
    ...
    log_watchdog                   = make_logger      ("editor.watchdog"                  );
}
