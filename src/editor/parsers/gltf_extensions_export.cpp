...
)
{
    ...
    // binding is what puts it in the file (doc/erhe/usd_compatibility_design.md U4).
...
)
{
    ...
    // KHR_materials_variants (doc/erhe/usd_compatibility_design.md X4): the scene's
    ...
    // the file as an erhe-authored scene.
    {
        ...
        // styles (doc/editor/style_library.md D4): every style item with its local
        ...
        // library_folders (doc/editor/content_library_folders.md D5): the tree
