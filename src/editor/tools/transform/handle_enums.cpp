...
auto get_handle_class(const Handle handle) -> Handle_class
{
    switch (handle) {
        ...
        case Handle::e_handle_translate_x : return Handle_class::e_handle_class_axis;
        case Handle::e_handle_translate_y : return Handle_class::e_handle_class_axis;
        case Handle::e_handle_translate_z : return Handle_class::e_handle_class_axis;
...
auto get_handle_axis(const Handle handle) -> Handle_axis
{
    switch (handle) {
        ...
        case Handle::e_handle_translate_x : return Handle_axis::e_handle_axis_x;
        case Handle::e_handle_translate_y : return Handle_axis::e_handle_axis_y;
        case Handle::e_handle_translate_z : return Handle_axis::e_handle_axis_z;
...
auto get_handle_plane(const Handle handle) -> Handle_plane
{
    switch (handle) {
        ...
        case Handle::e_handle_translate_x : return Handle_plane::e_handle_plane_none;
        case Handle::e_handle_translate_y : return Handle_plane::e_handle_plane_none;
        case Handle::e_handle_translate_z : return Handle_plane::e_handle_plane_none;
...
auto get_handle_tool(const Handle handle) -> Handle_tool
{
    switch (handle) {
        //using enum Handle;
        case Handle::e_handle_translate_x:  return Handle_tool::e_handle_tool_translate;
        case Handle::e_handle_translate_y:  return Handle_tool::e_handle_tool_translate;
        case Handle::e_handle_translate_z:  return Handle_tool::e_handle_tool_translate;
...
auto get_axis_mask(const Handle handle) -> unsigned int
{
    switch (handle) {
        //using enum Handle;
        case Handle::e_handle_translate_x:  return Axis_mask::x;
        case Handle::e_handle_translate_y:  return Axis_mask::y;
        case Handle::e_handle_translate_z:  return Axis_mask::z;
...
auto get_axis_color(const unsigned int axis_mask) -> glm::vec4
{
    switch (axis_mask) {
        //using enum Handle;
        case Axis_mask::x:  return glm::vec4{1.0f, 0.0f, 0.0f, 1.0f};
        case Axis_mask::y:  return glm::vec4{0.0f, 1.0f, 0.0f, 1.0f};
        case Axis_mask::z:  return glm::vec4{0.0f, 0.0f, 1.0f, 1.0f};
        case Axis_mask::yz: return glm::vec4{1.0f, 0.0f, 0.0f, 1.0f};
        case Axis_mask::xz: return glm::vec4{0.0f, 1.0f, 0.0f, 1.0f};
        case Axis_mask::xy: return glm::vec4{0.0f, 0.0f, 1.0f, 1.0f};
