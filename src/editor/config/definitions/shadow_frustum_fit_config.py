...
struct("Shadow_frustum_fit_config",
    ...
    fields=[
        ...
        field("fit_to_receivers",       Bool,  added_in=1, default="true",  short_desc="Fit To Receivers",       long_desc="Cull shadow casters against the receiver geometry volume (view frustum intersected with receiver bounds) extruded toward the light; refines Fit To Casters and has no effect without it"),
        field("fit_to_receivers_hull",  Bool,  added_in=1, default="true",  short_desc="Receivers Use Hull",      long_desc="Use the tighter convex receiver hull clipped to the view frustum instead of a bounding box for the receiver cull volume"),
