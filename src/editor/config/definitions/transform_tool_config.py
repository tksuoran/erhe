...
struct("Transform_tool_config",
    ...
    fields=[
        ...
        field(
            "rotate_start_marker_fade",
            Float,
            added_in=3,
            default="45.0f",
            ui_min="0.0f",
            ui_max="180.0f",
            short_desc="Rotate Start Marker Fade",
            long_desc="Fade distance in degrees of the axis-colored marker arc drawn during a rotation drag at the rotation start position. The arc covers the octant on the protractor sphere from the start position to the camera-facing end of the rotation axis, orthogonal to the rotation plane; its opacity falls linearly from full at the start position to zero at this arc distance. 0 hides it.",
            visible=True,
            developer=False
        ),
        field(
            "rotate_end_marker_fade",
            Float,
            added_in=3,
            default="45.0f",
            ui_min="0.0f",
            ui_max="180.0f",
            short_desc="Rotate End Marker Fade",
            long_desc="Fade distance in degrees of the axis-colored marker arc drawn during a rotation drag at the current (end) rotation position. The arc covers the octant on the protractor sphere from the current position to the camera-facing end of the rotation axis, orthogonal to the rotation plane; its opacity falls linearly from full at the current position to zero at this arc distance. 0 hides it.",
            visible=True,
            developer=False
        ),
        field(
        ...
        field(
            "hover_ring_band_half_width",
            Float,
            added_in=3,
            default="0.08f",
            ui_min="0.0f",
            ui_max="0.5f",
            short_desc="Hover Ring Band Half Width",
            long_desc="Half width of the filled highlight band drawn around a hovered rotate ring (Hover Preview), as a fraction of the ring radius: the band spans the ring radius minus to plus this amount.",
            visible=True,
            developer=False
        ),
        field(
            "hover_ring_band_opacity",
            Float,
            added_in=3,
            default="0.2f",
            ui_min="0.0f",
            ui_max="1.0f",
            short_desc="Hover Ring Band Opacity",
            long_desc="Opacity of the filled highlight band drawn around a hovered rotate ring (Hover Preview), 0..1. The band color is the ring's active color.",
            visible=True,
            developer=False
        ),
        field(
            ...
            ui_min="0.0f",
            ui_max="2.0f",
            short_desc="Gimbal Ring Gap",
            long_desc="Radial gap between neighboring rotate rings when the rings show the Euler angle gimbal (Rotation shown as Euler Angles), in view-scaled gizmo units. The first Euler ring is innermost; the third keeps the rotate ring radius.",
            visible=True,
            developer=False
        ),
        field(
