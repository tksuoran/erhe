...
struct("Transform_tool_config",
    ...
    fields=[
        ...
        field(
            "scale_plane_square_half_extent",
            Float,
            added_in=10,
            removed_in=11,
            default="0.5f",
            short_desc="Scale Plane Square Half Extent",
            long_desc="Half extent of the outline-only plane-scale squares when the translate quads are also shown, in view-scaled gizmo units. With translate hidden the squares take the translate quads' position and use Plane Quad Half Extent.",
            visible=True,
            developer=False
        ),
        field(
            "quad_center_clearance",
            Float,
            added_in=10,
            removed_in=11,
            default="0.5f",
            short_desc="Plane Quad Center Clearance",
            long_desc="Gap the translate plane quads keep from the gizmo center when the uniform-scale center cube is shown (positive-only translate mode), in view-scaled gizmo units, so the quads never touch the cube.",
            visible=True,
            developer=False
        ),
        field(
            ...
            removed_in=12,
            default="0.5f",
            short_desc="Center Sphere Radius",
            long_desc="Radius of the uniform-scale center sphere, in view-scaled gizmo units.",
            visible=True,
            developer=False
        ),
        field(
            "center_sphere_pick_radius",
            Float,
            added_in=11,
            removed_in=12,
            default="0.65f",
            short_desc="Center Sphere Pick Radius",
            long_desc="Pick sphere radius of the uniform-scale center sphere, in view-scaled gizmo units.",
            visible=True,
            developer=False
        ),
        field(
