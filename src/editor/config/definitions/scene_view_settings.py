...
struct("Scene_view_settings",
    ...
    fields=[
        ...
        field("viewport_config",      StructRef("Viewport_config"),              added_in=1, short_desc="Visual Style"),
        field("scene_and_camera",     StructRef("Scene_and_camera_settings"),    added_in=1, short_desc="Scene and Camera"),
    ],
)
