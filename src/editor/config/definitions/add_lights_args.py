...
struct("Add_lights_args",
    ...
    fields=[
        ...
        field(
            ...
            long_desc="Number of shadow-casting directional lights to create. Clamped to the active graphics preset's directional_shadow_light_count.",
            visible=True,
            developer=False
        ),
        field(
        ...
        field(
            ...
            long_desc="Number of shadow-casting spot lights to create. Clamped to the active graphics preset's spot_shadow_light_count.",
            visible=True,
            developer=False
        ),
        field(
