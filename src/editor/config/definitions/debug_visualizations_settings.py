...
struct("Debug_visualizations_settings",
    ...
    fields=[
        ...
        field("shadow_fit_debug",                  Bool,  added_in=1, default="false", short_desc="Shadow Fit",           long_desc="Master toggle for the shadow frustum fit visualizations"),
        field("shadow_fit_casters",                Bool,  added_in=1, default="false", short_desc="Fit Casters",          long_desc="Per-caster world AABBs, colored by whether the caster affects the selected light's shadow (intersects F_shadow) or is culled"),
        field("shadow_fit_caster_hull",            Bool,  added_in=1, default="false", short_desc="Fit Caster Hull",      long_desc="Convex hull around the caster bounds, before clipping to the shadow caster volume"),
        field("shadow_fit_view_frustum",           Bool,  added_in=1, default="false", short_desc="Fit View Frustum",     long_desc="Main camera view frustum, truncated to the shadow range - the region shadow receivers are filtered against"),
        field("shadow_fit_receivers",              Bool,  added_in=1, default="false", short_desc="Fit Receivers",        long_desc="Receiver world AABBs, colored by whether they pass the view frustum filter (and so contribute to the receiver-aware caster cull) or fail it"),
        field("shadow_fit_receiver_hull",           Bool, added_in=1, default="false", short_desc="Fit Receiver Hull Clipped",   long_desc="Convex hull of the receivers that intersect the view frustum, clipped to the view frustum - the body extruded toward the light into the caster cull volume (receiver analogue of the caster hull)"),
        field("shadow_fit_receiver_hull_unclipped", Bool, added_in=1, default="false", short_desc="Fit Receiver Hull Unclipped", long_desc="Convex hull of the receivers that intersect the view frustum, before the clip to the view frustum"),
        field("shadow_fit_volume_planes",          Bool,  added_in=1, default="false", short_desc="Fit Volume Planes",    long_desc="Shadow caster volume (F_shadow) planes the caster AABBs are tested against, drawn as bounded frustum faces"),
        field("shadow_fit_far_plane_hull",         Bool,  added_in=1, default="false", short_desc="Fit Far Plane Hull",   long_desc="Receiver silhouette (the 2D hull of the clipped receiver hull projected along the light onto the flat far cap) drawn as a closed loop in world space - the polygon the receiver caster-cull volume side planes are swept from; drawn directly, independent of the volume-planes reconstruction"),
        field("shadow_fit_points",                 Bool,  added_in=1, default="false", short_desc="Fit Points",           long_desc="Point set the light space box was fitted to (clipped caster hull or view frustum corners)"),
        field("shadow_fit_light_plane_hull",       Bool,  added_in=1, default="false", short_desc="Fit Light Plane Hull", long_desc="2D hull on the light plane with the rotating calipers OBB and its supporting edge"),
        field("shadow_fit_box_fit",                Bool,  added_in=1, default="false", short_desc="Fit Box: Points",      long_desc="Light space box after fitting to the point set"),
        field("shadow_fit_box_frustum",            Bool,  added_in=1, default="false", short_desc="Fit Box: Frustum",     long_desc="Light space box after the view frustum / near constraints"),
        field("shadow_fit_box_cap",                Bool,  added_in=1, default="false", short_desc="Fit Box: Range Cap",   long_desc="Light space box after the shadow range cap"),
        field("shadow_fit_box_final",              Bool,  added_in=1, default="false", short_desc="Fit Box: Final",       long_desc="Final light space box after quantize and texel snap; matches the light projection"),
