...
struct("Operation_params",
    ...
    fields=[
        ...
        field("subdivision_generate_texcoords", Bool, added_in=1, default="true",      short_desc="Subdivision generate UVs",   long_desc="Catmull-Clark / Sqrt3: when on, post-processing regenerates facet texture coordinates; when off the source UVs are interpolated through.", visible=True, developer=False),
