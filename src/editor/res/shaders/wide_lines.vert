...
void main()
{
    ...
    float max_size        = min(4.0 * primitive.primitives[ERHE_DRAW_ID].size, 20.0);
    ...
    vs_line_width = (1.0 / 1024.0) * viewport_width * max(max_size / d, 1.0) / fov_width; //primitive.primitives[ERHE_DRAW_ID].size;
}
