...
auto Rendertarget_imgui_host::get_consumer_input_texture(
...
auto Rendertarget_imgui_host::get_producer_output_texture(
...
auto Rendertarget_imgui_host::get_consumer_input_framebuffer(
    const erhe::rendergraph::Routing resource_routing,
    const int                        key,
    const int                        depth
...
auto Rendertarget_imgui_host::get_consumer_input_viewport(
    const erhe::rendergraph::Routing resource_routing,
    const int                        key,
    const int                        depth
...
auto Rendertarget_imgui_host::get_producer_output_viewport(
    const erhe::rendergraph::Routing resource_routing,
    const int                        key,
    const int                        depth
) const -> erhe::math::Viewport
