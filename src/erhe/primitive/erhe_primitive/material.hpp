...
// sampler properties (section 4.1 of doc/erhe/property_system.md). The renderer
...
// (doc/erhe/property_system.md section 4.1): the texture_reference (D28), the
...
public:
    ...
    // `UsdShadeMaterial`'s (doc/erhe/usd_compatibility.md, "Materials").
    ...
    // (doc/erhe/property_system.md D32: a local value is an authored value).
    ...
    // that issued it (doc/erhe/draw_list_material_set.md D0), not of the
