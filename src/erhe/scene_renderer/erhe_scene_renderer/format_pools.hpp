...
// returns a Format_pools& keyed by the uint64_t hash produced by
// compute_vertex_format_key (folds stream bindings, strides, and every
// attribute's usage/usage_index/format/offset).
class Format_pools
{
public:
    Format_pools(
