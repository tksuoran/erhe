...
// Shadow caster sub-variant (doc/erhe/draw_list_renderer.md R4a):
...
// (doc/erhe/draw_list_renderer.md R13/R14). Owned by
...
public:
    ...
    // (doc/erhe/draw_list_performance_improvements.md): entries.size() records of
