...
) -> erhe::graphics::Ring_buffer_range
{
    ...
    // any cameras[u_view_index] within range. Entries past index 0 are
    // left zero-initialised on the single-view path.
...
) -> erhe::graphics::Ring_buffer_range
{
    ...
    // cameras[u_view_index] would alias entries we never wrote.
