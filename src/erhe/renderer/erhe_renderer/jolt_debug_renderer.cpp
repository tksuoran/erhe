...
JPH::DebugRenderer::Batch Jolt_debug_renderer::CreateTriangleBatch(const Triangle* inTriangles, int inTriangleCount)
{
...
JPH::DebugRenderer::Batch Jolt_debug_renderer::CreateTriangleBatch(const Vertex* inVertices, int inVertexCount, const JPH::uint32* inIndices, int inIndexCount)
{
    BatchImpl* batch = new BatchImpl;
