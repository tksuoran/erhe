...
void Render_command_encoder::set_buffer(Buffer_target buffer_target, const Buffer* buffer, std::uintptr_t offset, std::uintptr_t length, std::uintptr_t index)
{
...
void Render_command_encoder::draw_primitives(Primitive_type primitive_type, std::uintptr_t vertex_start, std::uintptr_t vertex_count, std::uintptr_t instance_count)
{
    m_impl->draw_primitives(primitive_type, vertex_start, vertex_count, instance_count);
}
void Render_command_encoder::draw_primitives(Primitive_type primitive_type, std::uintptr_t vertex_start, std::uintptr_t vertex_count)
{
    m_impl->draw_primitives(primitive_type, vertex_start, vertex_count);
}
void Render_command_encoder::draw_indexed_primitives(Primitive_type primitive_type, std::uintptr_t index_count, erhe::dataformat::Format index_type, std::uintptr_t index_buffer_offset, std::uintptr_t instance_count)
{
    m_impl->draw_indexed_primitives(primitive_type, index_count, index_type, index_buffer_offset, instance_count);
}
void Render_command_encoder::draw_indexed_primitives(Primitive_type primitive_type, std::uintptr_t index_count, erhe::dataformat::Format index_type, std::uintptr_t index_buffer_offset)
{
