...
//auto Device::make_render_command_encoder(const std::shared_ptr<Render_pass>& framebuffer) -> std::shared_ptr<Render_command_encoder>&;
//{
//    return std::make_shared<Render_command_encoder>(*this, framebuffer);
//}
