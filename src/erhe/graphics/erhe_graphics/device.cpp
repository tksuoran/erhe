...
void Buffer_range::bytes_gpu_used(std::size_t byte_count)
{
...
auto GPU_ring_buffer::acquire(std::size_t required_alignment, Ring_buffer_usage ring_buffer_usage, std::size_t byte_count) -> Buffer_range
{
    return m_impl->acquire(required_alignment, ring_buffer_usage, byte_count);
}
auto GPU_ring_buffer::match(Ring_buffer_usage usage) const -> bool
{
