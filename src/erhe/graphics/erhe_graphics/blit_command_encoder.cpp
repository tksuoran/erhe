...
)
{
    ...
    gl::bind_buffer(gl::Buffer_target::pixel_unpack_buffer, source_buffer->gl_name());
    ...
    switch (destination_texture->get_storage_dimensions(gl_destination_texture_target)) {
        case 1: {
...
)
{
    ...
    gl::bind_buffer(gl::Buffer_target::pixel_pack_buffer, destination_buffer->gl_name());
...
)
{
    ...
    gl::copy_named_buffer_sub_data(
        source_buffer->gl_name(),
        destination_buffer->gl_name(),
        source_offset,
        destination_offset,
        size
    );
