...
// OpenGL backend: no GPU ray tracing support. Device_info::use_ray_query is
// false, so application code is expected not to exercise this path; the stubs
// exist so shared code compiles unchanged.
