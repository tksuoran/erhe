...
Ring_buffer_impl::Ring_buffer_impl(
    Device&                        device,
...
auto Ring_buffer_impl::get_buffer() -> Buffer*
{
    return m_buffer.get();
}

auto Ring_buffer_impl::get_name() const -> const std::string&
{
    return m_name;
}

void Ring_buffer_impl::sanity_check()
{
...
void Ring_buffer_impl::get_size_available_for_write(
...
auto Ring_buffer_impl::acquire(std::size_t required_alignment, Ring_buffer_usage ring_buffer_usage, std::size_t byte_count) -> Ring_buffer_range
{
...
auto Ring_buffer_impl::match(const Ring_buffer_usage ring_buffer_usage) const -> bool
{
    return m_ring_buffer_usage == ring_buffer_usage; // TODO some usages might be compatible with each other?
}

void Ring_buffer_impl::flush(std::size_t byte_offset, std::size_t byte_count)
{
    ERHE_PROFILE_FUNCTION();
...
void Ring_buffer_impl::close(std::size_t byte_offset, std::size_t byte_write_count)
{
    ERHE_PROFILE_FUNCTION();
...
void Ring_buffer_impl::frame_completed(uint64_t completed_frame)
{
    ERHE_PROFILE_FUNCTION();
...
void Ring_buffer_impl::wrap_write()
{
    ERHE_PROFILE_FUNCTION();
...
void Ring_buffer_impl::make_sync_entry(std::size_t wrap_count, std::size_t byte_offset, std::size_t byte_count)
{
    ERHE_PROFILE_FUNCTION();
