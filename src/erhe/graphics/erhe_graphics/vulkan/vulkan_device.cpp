...
) -> VkBool32
{
    if (callback_data->messageIdNumber == 0x675dc32e) {
        ...
        // vkCreateInstance(): Attempting to enable extension VK_EXT_debug_utils, but this extension is intended
        // to support use by applications when debugging and it is strongly recommended that it be otherwise avoided.
    }
