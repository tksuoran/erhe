// The prim class hierarchy of doc/erhe/usd_compatibility_design.md C5 as erhe sees
...
// A point instancer is a boundable prim (doc/erhe/usd_compatibility_design.md S1):
