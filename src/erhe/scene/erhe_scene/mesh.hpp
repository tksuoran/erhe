...
// mesh (doc/erhe/property_system.md D29): a Dependency_object with its own owner
...
public:
    ...
    // lightmap baker (doc/editor/lightmap_baking.md), uploaded per draw by
    // Primitive_buffer.
...
// A geometric prim (doc/erhe/usd_compatibility_design.md C5, USD `Mesh`): an
...
public:
    ...
    // (doc/erhe/meshoptimizer_integration.md, requirement 11). Called when the edit
    ...
    // Computed (doc/erhe/property_system.md D26): the corners of
    ...
    // Inherited flags (doc/erhe/property_system.md D23): the closest ancestor
