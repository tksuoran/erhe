...
// (doc/erhe/usd_compatibility_design.md X2). `relative_path` is the M1 path of the
...
// What an override of an instance item is (doc/erhe/usd_compatibility_design.md X2,
// doc/erhe/property_system.md D33), stated once:
//
...
// USD `class` prim's opinions (doc/erhe/usd_compatibility_design.md X3) are made of.
...
// was applied to (doc/erhe/usd_compatibility_design.md C6). erhe keeps the arc's
