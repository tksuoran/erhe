...
class Jolt_tapered_capsule_shape : public Jolt_collision_shape
{
public:
    Jolt_tapered_capsule_shape(Axis axis, float bottom_radius, float top_radius, float length);
    ~Jolt_tapered_capsule_shape() noexcept override;
