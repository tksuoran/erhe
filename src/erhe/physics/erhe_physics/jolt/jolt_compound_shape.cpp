...
auto Jolt_compound_shape::get_shape_type() const -> Collision_shape_type
{
    return Collision_shape_type::e_compound;
}

auto Jolt_compound_shape::get_children() const -> const std::vector<Compound_child>&
{
    return m_children;
}
