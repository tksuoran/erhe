...
auto make_convex_hull_shape_settings(const float* const point_data, const int point_count, const int stride) -> JPH::ConvexHullShapeSettings
{
...
Jolt_convex_hull_collision_shape::Jolt_convex_hull_collision_shape(const float* point_data, const int point_count, const int stride)
{
