...
void Imgui_renderer::render_draw_data()
{
    ...
    Buffer_range draw_parameter_buffer_range = m_draw_parameter_buffer.allocate_range(usage, draw_parameter_byte_count);
    Buffer_range draw_indirect_buffer_range  = m_draw_indirect_buffer .allocate_range(usage, draw_indirect_byte_count);
    Buffer_range vertex_buffer_range         = m_vertex_buffer        .allocate_range(usage, vertex_byte_count);
    Buffer_range index_buffer_range          = m_index_buffer         .allocate_range(usage, index_byte_count);
