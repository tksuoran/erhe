...
- `Headset_config` -- Configuration flags (codegen-generated from `definitions/headset_config.py`): openxr enable, openxr_mirror, debug, validation, api_dump, quad view, depth, swapchain_depth, visibility_mask, hand tracking, passthrough_fb, composition_alpha, CPU/GPU performance level, boost_on_thermal_warning.
