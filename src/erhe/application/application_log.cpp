...
{
    log_command_state_transition = erhe::log::make_logger("erhe::application::command_state_transition", spdlog::level::trace);
    log_input                    = erhe::log::make_logger("erhe::application::input",                    spdlog::level::trace);
    log_input_event              = erhe::log::make_logger("erhe::application::input_event",              spdlog::level::trace);
    log_input_event_consumed     = erhe::log::make_logger("erhe::application::input_event_consumed",     spdlog::level::trace);
    log_input_event_filtered     = erhe::log::make_logger("erhe::application::input_event_filtered",     spdlog::level::trace);
    log_input_events             = erhe::log::make_logger("erhe::application::input_events",             spdlog::level::trace);
    ...
    log_tools                    = erhe::log::make_logger("erhe::application::tools",                    spdlog::level::trace);
    ...
    log_update                   = erhe::log::make_logger("erhe::application::update",                   spdlog::level::info);
}
