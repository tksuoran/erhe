...
// test_grid.cpp constructs erhe::geometry::Geometry (GEO::Mesh), so Geogram
// and the erhe::geometry log sinks must be initialized just as in
// src/erhe/geometry/test/main.cpp; otherwise any geometry log call would
// dereference a null spdlog pointer.
