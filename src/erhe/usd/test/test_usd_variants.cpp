// Variant sets (doc/erhe/usd_compatibility_design.md X4). LightUSD composes nothing,
...
{
    const std::filesystem::path directory = erhe_usd_test::process_temporary_directory() / "erhe_usd_variant_tests";
