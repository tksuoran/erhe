...
{
    const std::filesystem::path directory = erhe_usd_test::process_temporary_directory() / "erhe_usd_xform_op_tests";
...
// authored ops has to come back byte for byte (doc/erhe/usd_compatibility_design.md
// M8).
