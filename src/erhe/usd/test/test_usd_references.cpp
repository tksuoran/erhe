...
// ---------------------------------------------------------------------------
// Export (doc/erhe/usd_compatibility_design.md X1, save side)
// ---------------------------------------------------------------------------
...
// (doc/erhe/property_system.md D33). That link is what tells instance content
...
// ---------------------------------------------------------------------------
// Sparse overrides (doc/erhe/usd_compatibility_design.md X2)
// ---------------------------------------------------------------------------
...
// reads back (doc/erhe/usd_compatibility_design.md X2).
...
public:
    Override_scene()
    {
        ...
        // xformOp stack (doc/erhe/usd_compatibility_design.md M8), which the writer
...
// ---------------------------------------------------------------------------
// A material binding authored as an override (doc/erhe/usd_compatibility_design.md
...
// ---------------------------------------------------------------------------
// Carriers that carry no transform of their own (doc/erhe/usd_compatibility_design.md
...
// (doc/erhe/usd_compatibility_design.md X1): the shape the usd-wg
