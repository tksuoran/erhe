...
// (doc/erhe/usd_compatibility_design.md U4): the reader parents a `Material` prim
...
{
    const std::filesystem::path directory = erhe_usd_test::process_temporary_directory() / "erhe_usd_material_tests";
