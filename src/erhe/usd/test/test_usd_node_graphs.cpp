...
// (doc/plans/usd_texture_graphs.md). The reader records every `NodeGraph` prim
...
TEST_F(Node_graphs_import, an_input_with_a_value_is_a_parameter_of_its_authored_type)
{
    ...
    // a gradient rides the file (doc/plans/usd_texture_graphs.md 2.1).
...
// again spells the same file (doc/plans/usd_texture_graphs.md R4).
