...
// (doc/erhe/usd_compatibility.md, Materials; doc/erhe/usd.md).
...
{
    const std::filesystem::path directory = erhe_usd_test::process_temporary_directory() / "erhe_usd_open_pbr_tests";
