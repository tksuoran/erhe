// UsdSkel skinning (doc/erhe/usd_compatibility_design.md K1): a `Skeleton` prim is a
...
{
    const std::filesystem::path directory = erhe_usd_test::process_temporary_directory() / "erhe_usd_skinning_tests";
...
// The export half (doc/erhe/usd_compatibility_design.md K1): the `Skeleton` prim is
