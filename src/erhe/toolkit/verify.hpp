...
#define ERHE_FATAL(format, ...) do { printf("%s:%d " format, std::source_location::current().file_name(), std::source_location::current().line(), ##__VA_ARGS__); DebugBreak(); abort(); } while (1)
