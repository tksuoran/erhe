...
class Tinybvh_instance : public IInstance
{
public:
    explicit Tinybvh_instance(std::string_view debug_label);
    ~Tinybvh_instance() noexcept override;
